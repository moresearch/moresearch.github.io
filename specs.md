...
- /talks/ is an index page listing all available talks with links to each viewer. The Hackspree logo must be displayed in the same position and style as the main blog.
