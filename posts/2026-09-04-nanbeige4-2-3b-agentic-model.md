...
- Bae, S., Kim, Y., Bayat, R., et al. [Mixture-of-Recursions: Learning Dynamic Recursive Depths for Adaptive Token-Level Computation](https://arxiv.org/abs/2507.10524), arXiv:2507.10524 [cs.CL], July 2025; NeurIPS 2025. A learned router decides per token how many recursive passes to run through a shared block — the dynamic-depth lineage Raschka traces for Nanbeige 4.2's layer reuse.
